...
List<Repos> reposFromJson(String str) =>
    List<Repos>.from(json.decode(str).map((x) => Repos.fromJson(x)));

String reposToJson(List<Repos> data) =>
...
class Repos {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "created_at": createdAt ?? createdAt.toString(),
        "updated_at": updatedAt ?? updatedAt.toString(),
        "pushed_at": pushedAt ?? pushedAt.toString(),
        "git_url": gitUrl,
        "ssh_url": sshUrl,
        "clone_url": cloneUrl,
        "svn_url": svnUrl,
